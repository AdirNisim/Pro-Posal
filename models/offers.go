...
var offerAfterSelectMu sync.Mutex
var offerAfterSelectHooks []OfferHook

var offerBeforeInsertMu sync.Mutex
var offerBeforeInsertHooks []OfferHook
var offerAfterInsertMu sync.Mutex
var offerAfterInsertHooks []OfferHook

var offerBeforeUpdateMu sync.Mutex
var offerBeforeUpdateHooks []OfferHook
var offerAfterUpdateMu sync.Mutex
var offerAfterUpdateHooks []OfferHook

var offerBeforeDeleteMu sync.Mutex
var offerBeforeDeleteHooks []OfferHook
var offerAfterDeleteMu sync.Mutex
var offerAfterDeleteHooks []OfferHook

var offerBeforeUpsertMu sync.Mutex
var offerBeforeUpsertHooks []OfferHook
var offerAfterUpsertMu sync.Mutex
	...
	if !cached {
		...
		if len(conflict) == 0 && updateOnConflict && len(update) != 0 {
			if len(offerPrimaryKeyColumns) == 0 {
				return errors.New("models: unable to upsert offers, could not build conflict column list")
			}
