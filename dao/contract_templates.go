...
func (q contractTemplateQuery) One(ctx context.Context, exec boil.ContextExecutor) (*ContractTemplate, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "dao: failed to execute a one query for contract_templates")
	}
...
func (q contractTemplateQuery) All(ctx context.Context, exec boil.ContextExecutor) (ContractTemplateSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "dao: failed to assign all query results to ContractTemplate slice")
	}
...
func (q contractTemplateQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "dao: failed to count contract_templates rows")
	}
...
func (q contractTemplateQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "dao: failed to check if contract_templates exists")
	}
...
func FindContractTemplate(ctx context.Context, exec boil.ContextExecutor, iD string, selectCols ...string) (*ContractTemplate, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "dao: unable to select from contract_templates")
	}
...
func (o *ContractTemplate) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("dao: no contract_templates provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "dao: unable to insert into contract_templates")
	}
...
func (o *ContractTemplate) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("dao: unable to update contract_templates, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "dao: unable to update contract_templates row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "dao: failed to get rows affected by update for contract_templates")
	}
...
func (q contractTemplateQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "dao: unable to update all for contract_templates")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "dao: unable to retrieve rows affected for contract_templates")
	}
...
func (o ContractTemplateSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "dao: unable to update all in contractTemplate slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "dao: unable to retrieve rows affected all in update all contractTemplate")
	}
	return rowsAff, nil
}
...
func (o *ContractTemplate) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns, opts ...UpsertOptionFunc) error {
	if o == nil {
		return errors.New("dao: no contract_templates provided for upsert")
	}
	if !boil.TimestampsAreSkipped(ctx) {
		currTime := time.Now().In(boil.GetLocation())
	...
	if !cached {
		...
		if updateOnConflict && len(update) == 0 {
			return errors.New("dao: unable to upsert contract_templates, could not build update column list")
		}
		...
		if len(conflict) == 0 && updateOnConflict && len(update) != 0 {
			if len(contractTemplatePrimaryKeyColumns) == 0 {
				return errors.New("dao: unable to upsert contract_templates, could not build conflict column list")
			}
	...
	if err != nil {
		return errors.Wrap(err, "dao: unable to upsert contract_templates")
	}
...
func (o *ContractTemplate) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("dao: no ContractTemplate provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "dao: unable to delete from contract_templates")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "dao: failed to get rows affected by delete for contract_templates")
	}
...
func (q contractTemplateQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("dao: no contractTemplateQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "dao: unable to delete all from contract_templates")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "dao: failed to get rows affected by deleteall for contract_templates")
	}
...
func (o ContractTemplateSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "dao: unable to delete all from contractTemplate slice")
	}
...
func (o *ContractTemplateSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "dao: unable to reload all in ContractTemplateSlice")
	}
...
func ContractTemplateExists(ctx context.Context, exec boil.ContextExecutor, iD string) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "dao: unable to check if contract_templates exists")
	}
